...
{
    public interface ICondition<TConditionType>
        where TConditionType: struct
    {
        void GetConditionTypes(ICollection<TConditionType> list);
        bool CheckCondition();
    }
    public interface IResponder<T, TConditionType>
        where T: ICondition<TConditionType>
        where TConditionType: struct
    {
        void Reset();
        void Destroy();
    ...
    /// 条件响应器
    public class Responder<T, TConditionType>: IResponder<T, TConditionType>
        where T: ICondition<TConditionType>
        where TConditionType: struct
    {
        /// kv 映射 配置
        ...
        void IResponder<T, TConditionType>.Subscribe(T t, Action<T, bool> callback)
        {
            ...
            {
                wrapper = ConditionDataWrapper<T, TConditionType>.Get(t);
                AddData(wrapper, t);
            }
            ...
            where TConditionType: struct
        {
            ...
            {
                t.GetConditionTypes(eConditionTypes);
            }
