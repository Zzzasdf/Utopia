...
namespace Generator.Ring111
{
    public partial class Generator
    {
        ...
        private class ItemContainer
        {
            ...
            private Queue<Item> recycle = new();
            ...
            public ItemContainer(Transform parentTra, Item itemTmp,
                ...
                int count, int selectedIndex)
            {
                ...
                void SetItemCount()
                {
                    ...
                    Item GetItem()
                    {
                        ...
                        if (recycle.Count == 0)
                        {
                            Item item = Instantiate(itemTmp, parentTra);
                ...
                void RefreshItemStatus(EShape eShape, int xAxisRadius, int yAxisRadius, int startAngle, EDirection eGenerateDir)
                {
                    ...
                    void SetItem(Item item, int index, IShape shape, int xAxisRadius, int yAxisRadius, float angle)
                    {
            ...
            {
                SetScrollUntilIndex(directionInfo.EGenerateDir() == eScrollDir ? CurSelectedIndex - time : CurSelectedIndex + time, eScrollDir);
